...
const bodyContent = ` <header class="header">
<div class="container header__container">
    <h1 class="header__title">Virtual Keyboard</h1>
    <h2 class="header__subtitle">The keyboard was created in the Windows operating system</h2>
    <div class="header__hints">
      <p class="header__hint">Press the SHIFT: make the letters uppercase, and show the symbols</p>
      <p class="header__hint">Press Ctrl + Alt: language switching</p>
    </div>
</div>
</header>
...
<div class="container main__container">
    <div class="keyboard-input__container">
        <textarea name="field-text" placeholder="Write something..." class="keyboard-input" cols="70"
            rows="7" autofocus></textarea>
    </div>
</div>
</main>
...
<div class="container footer__container">
    <a href="https://github.com/radiance77" class="github-link" target="_blank">radiance77</a>
</div>
</footer>`;
...
const en = {
  keyLayout: [
    ...
    ['Control', 'Alt', ' ', 'Control', 'ArrowLeft', 'ArrowDown', 'ArrowRight'],
  ],
